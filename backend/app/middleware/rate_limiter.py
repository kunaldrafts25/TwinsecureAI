...
class RateLimiterMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(
        ...
        logger.info(f"Rate limiter middleware initialized with {max_requests} requests per {time_window} seconds")
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        if not allowed:
            ...
            response.headers["X-RateLimit-Reset"] = str(int(time.time() + self.rate_limiter.time_window))
